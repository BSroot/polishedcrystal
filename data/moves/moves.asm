...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move DOUBLE_SLAP,  EFFECT_MULTI_HIT,          20, NORMAL,    100, 10,   0, PHYSICAL
	...
	move AIR_SLASH,    EFFECT_FLINCH_HIT,         75, FLYING,    100, 15,  30, SPECIAL
	move SWORDS_DANCE, EFFECT_ATTACK_UP_2,         0, NORMAL,    100, 20,   0, STATUS
if DEF(FAITHFUL)
	move CUT,          EFFECT_NORMAL_HIT,         50, NORMAL,    100, 30,   0, PHYSICAL
else
...
if DEF(FAITHFUL)
	...
	move FLY,          EFFECT_FLY,                90, FLYING,    100, 15,   0, PHYSICAL
endc
	move DAZZLINGLEAM, EFFECT_NORMAL_HIT,         80, FAIRY,     100, 15,   0, SPECIAL
	...
	move STONE_EDGE,   EFFECT_NORMAL_HIT,        100, ROCK,      100, 10,   0, PHYSICAL
	move FOCUS_BLAST,  EFFECT_SP_DEF_DOWN_HIT,   110, FIGHTING,   90, 10,  10, SPECIAL
	...
	move HEX,          EFFECT_CONDITIONAL_BOOST,  65, GHOST,     100, 15,   0, SPECIAL
	move TACKLE,       EFFECT_NORMAL_HIT,         40, NORMAL,    100, 35,   0, PHYSICAL
	move BODY_SLAM,    EFFECT_BODY_SLAM,          85, NORMAL,    100, 15,  30, PHYSICAL
	move WRAP,         EFFECT_TRAP,               15, NORMAL,    100, 20,   0, PHYSICAL
if DEF(FAITHFUL)
	move TAKE_DOWN,    EFFECT_NORMAL_HIT,         90, NORMAL,    100, 20,   0, PHYSICAL
else
	move TAKE_DOWN,    EFFECT_NORMAL_HIT,         90, NORMAL,    100, 15,   0, PHYSICAL
endc
	...
	move POISON_STING, EFFECT_POISON_HIT,         25, POISON,    100, 35,  30, PHYSICAL
	move U_TURN,       EFFECT_SWITCH_HIT,         60, BUG,       100, 20,   0, PHYSICAL
	move PIN_MISSILE,  EFFECT_MULTI_HIT,          25, BUG,       100, 20,   0, PHYSICAL
...
if DEF(FAITHFUL)
	...
	move SUPERSONIC,   EFFECT_CONFUSE,             0, NORMAL,    100, 20,   0, STATUS
else
	move SING,         EFFECT_SLEEP,               0, NORMAL,     75, 15,   0, STATUS
	move SUPERSONIC,   EFFECT_CONFUSE,             0, NORMAL,    100, 20,   0, STATUS
endc
	move SONIC_BOOM,   EFFECT_STATIC_DAMAGE,      20, NORMAL,    100, 20,   0, SPECIAL
	...
	move HYDRO_PUMP,   EFFECT_NORMAL_HIT,        110, WATER,      90, 10,   0, SPECIAL
	move SURF,         EFFECT_NORMAL_HIT,         90, WATER,     100, 15,   0, SPECIAL
	move ICE_BEAM,     EFFECT_FREEZE_HIT,         90, ICE,       100, 15,  10, SPECIAL
	move BLIZZARD,     EFFECT_FREEZE_HIT,        110, ICE,        90, 10,  10, SPECIAL
	...
	move HYPER_BEAM,   EFFECT_HYPER_BEAM,        150, NORMAL,    100,  5,   0, SPECIAL
	move PECK,         EFFECT_NORMAL_HIT,         35, FLYING,    100, 35,   0, PHYSICAL
	move DRILL_PECK,   EFFECT_NORMAL_HIT,         80, FLYING,    100, 20,   0, PHYSICAL
	move CLOSE_COMBAT, EFFECT_CLOSE_COMBAT,      120, FIGHTING,  100, 10,   0, PHYSICAL
...
endc
	...
	move MEGA_DRAIN,   EFFECT_LEECH_HIT,          55, GRASS,     100, 20,   0, SPECIAL
	move LEECH_SEED,   EFFECT_LEECH_SEED,          0, GRASS,     100, 20,   0, STATUS
	move GROWTH,       EFFECT_GROWTH,              0, NORMAL,    100, 20,   0, STATUS
	move RAZOR_LEAF,   EFFECT_NORMAL_HIT,         60, GRASS,     100, 25,   0, PHYSICAL
	move SOLAR_BEAM,   EFFECT_SOLAR_BEAM,        140, GRASS,     100, 10,   0, SPECIAL
	move POISONPOWDER, EFFECT_POISON,              0, POISON,    100, 35,   0, STATUS
	move STUN_SPORE,   EFFECT_PARALYZE,            0, GRASS,     100, 30,   0, STATUS
	move SLEEP_POWDER, EFFECT_SLEEP,               0, GRASS,      75, 15,   0, STATUS
	move PETAL_DANCE,  EFFECT_RAMPAGE,           120, GRASS,     100, 10,   0, SPECIAL
	move STRING_SHOT,  EFFECT_SPEED_DOWN_2,        0, BUG,       100, 40,   0, STATUS
	move DRAGON_RAGE,  EFFECT_STATIC_DAMAGE,      60, DRAGON,    100, 20,   0, SPECIAL
if DEF(FAITHFUL)
	move FIRE_SPIN,    EFFECT_TRAP,               35, FIRE,      100, 15,   0, SPECIAL
else
	move FIRE_SPIN,    EFFECT_TRAP,               40, FIRE,      100, 15,   0, SPECIAL
endc
	...
	move THUNDER,      EFFECT_THUNDER,           110, ELECTRIC,   90, 10,  30, SPECIAL
	...
	move AVALANCHE,    EFFECT_CONDITIONAL_BOOST,  60, ICE,       100, 15,   0, PHYSICAL
if DEF(FAITHFUL)
	move DIG,          EFFECT_FLY,                80, GROUND,    100, 20,   0, PHYSICAL
else
	move DIG,          EFFECT_FLY,                90, GROUND,    100, 20,   0, PHYSICAL
endc
	...
	move DRAGON_PULSE, EFFECT_NORMAL_HIT,         85, DRAGON,    100, 15,   0, SPECIAL
	move SCREECH,      EFFECT_DEFENSE_DOWN_2,      0, NORMAL,    100, 40,   0, STATUS
	...
	move AQUA_TAIL,    EFFECT_NORMAL_HIT,         90, WATER,     100, 15,   0, PHYSICAL
	...
	move FLASH_CANNON, EFFECT_SP_DEF_DOWN_HIT,    80, STEEL,     100, 15,  10, SPECIAL
if DEF(FAITHFUL)
	move METRONOME,    EFFECT_METRONOME,           0, NORMAL,    100, 20,   0, STATUS
else
	move METRONOME,    EFFECT_METRONOME,           0, UNKNOWN_T, 100, 20,   0, STATUS
endc
	move SCALD,        EFFECT_BURN_HIT,           80, WATER,     100, 15,  30, SPECIAL
	move TRICK_ROOM,   EFFECT_TRICK_ROOM,          0, PSYCHIC,   100, 10,   0, STATUS
	move SKILL_SWAP,   EFFECT_SKILL_SWAP,          0, PSYCHIC,   100, 10,   0, STATUS
	move LICK,         EFFECT_PARALYZE_HIT,       30, GHOST,     100, 30,  30, PHYSICAL
	move GUNK_SHOT,    EFFECT_POISON_HIT,        120, POISON,    100, 10,  30, PHYSICAL
	move VENOSHOCK,    EFFECT_CONDITIONAL_BOOST,  70, POISON,    100, 15,   0, SPECIAL
	move EARTH_POWER,  EFFECT_SP_DEF_DOWN_HIT,    90, GROUND,    100, 15,  10, SPECIAL
	move FIRE_BLAST,   EFFECT_BURN_HIT,          110, FIRE,       90, 10,  10, SPECIAL
	move WATERFALL,    EFFECT_FLINCH_HIT,         80, WATER,     100, 15,  20, PHYSICAL
	move ICICLE_CRASH, EFFECT_FLINCH_HIT,         85, ICE,       100, 15,  30, PHYSICAL
	...
	move DREAM_EATER,  EFFECT_DREAM_EATER,       120, PSYCHIC,   100, 15,   0, SPECIAL
	...
	move DRAIN_KISS,   EFFECT_LEECH_HIT,          50, FAIRY,     100, 15,   0, SPECIAL
	...
	move DIZZY_PUNCH,  EFFECT_CONFUSE_HIT,        70, NORMAL,    100, 15,  20, PHYSICAL
...
if DEF(FAITHFUL)
	move CRABHAMMER,   EFFECT_NORMAL_HIT,        100, WATER,     100, 10,   0, PHYSICAL
else
	move CRABHAMMER,   EFFECT_NORMAL_HIT,        100, WATER,     100, 10,   0, PHYSICAL
endc
	move EXPLOSION,    EFFECT_EXPLOSION,         250, NORMAL,    100,  5,   0, PHYSICAL
if DEF(FAITHFUL)
	move FURY_STRIKES, EFFECT_FURY_STRIKES,       20, NORMAL,    100, 15,   0, PHYSICAL
else
	move FURY_STRIKES, EFFECT_FURY_STRIKES,       20, NORMAL,    100, 15,   0, PHYSICAL
endc
	move BONEMERANG,   EFFECT_DOUBLE_HIT,         50, GROUND,    100, 10,   0, PHYSICAL
	move REST,         EFFECT_HEAL,                0, PSYCHIC,   100, 10,   0, STATUS
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         75, ROCK,      100, 15,  30, PHYSICAL
	...
	move TRI_ATTACK,   EFFECT_TRI_ATTACK,         80, NORMAL,    100, 15,  20, SPECIAL
	move SUPER_FANG,   EFFECT_SUPER_FANG,          1, NORMAL,    100, 15,   0, PHYSICAL
	move SLASH,        EFFECT_NORMAL_HIT,         70, NORMAL,    100, 20,   0, PHYSICAL
	move SUBSTITUTE,   EFFECT_SUBSTITUTE,          0, NORMAL,    100, 10,   0, STATUS
	move GIGA_IMPACT,  EFFECT_HYPER_BEAM,        150, NORMAL,    100,  5,   0, PHYSICAL
	move SKETCH,       EFFECT_SKETCH,              0, NORMAL,    100,  1,   0, STATUS
	move DRAIN_PUNCH,  EFFECT_LEECH_HIT,          75, FIGHTING,  100, 15,   0, PHYSICAL
	move THIEF,        EFFECT_THIEF,              60, DARK,      100, 25, 100, PHYSICAL
	move WILL_O_WISP,  EFFECT_BURN,                0, FIRE,       90, 15,   0, STATUS
	move ZEN_HEADBUTT, EFFECT_FLINCH_HIT,         80, PSYCHIC,   100, 15,  20, PHYSICAL
	...
	move HYPER_VOICE,  EFFECT_NORMAL_HIT,         90, NORMAL,    100, 15,   0, SPECIAL
	move CURSE,        EFFECT_CURSE,               0, GHOST,     100, 10,   0, STATUS
	move GYRO_BALL,    EFFECT_GYRO_BALL,           1, STEEL,     100, 10,   0, PHYSICAL
	...
	move SWEET_KISS,   EFFECT_CONFUSE,             0, FAIRY,     100, 10,   0, STATUS
	move BELLY_DRUM,   EFFECT_BELLY_DRUM,          0, NORMAL,    100, 10,   0, STATUS
	move SLUDGE_BOMB,  EFFECT_POISON_HIT,         90, POISON,    100, 15,  30, SPECIAL
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  30, GROUND,    100, 20, 100, SPECIAL
if DEF(FAITHFUL)
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  65, WATER,     100, 10,  50, SPECIAL
else
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  75, WATER,     100, 10,  30, SPECIAL
endc
	move SPIKES,       EFFECT_SPIKES,              0, GROUND,    100, 20,   0, STATUS
	move ZAP_CANNON,   EFFECT_PARALYZE_HIT,      120, ELECTRIC,  90,  5,   60, SPECIAL
	...
	move ICY_WIND,     EFFECT_SPEED_DOWN_HIT,     55, ICE,       100, 15, 100, SPECIAL
	...
	move POWER_WHIP,   EFFECT_NORMAL_HIT,        100, GRASS,     100, 10,   0, PHYSICAL
	move OUTRAGE,      EFFECT_RAMPAGE,           120, DRAGON,    100, 10,   0, PHYSICAL
	move SANDSTORM,    EFFECT_SANDSTORM,           0, ROCK,      100, 10,   0, STATUS
	move GIGA_DRAIN,   EFFECT_LEECH_HIT,          75, GRASS,     100, 15,   0, SPECIAL
	move ENDURE,       EFFECT_ENDURE,              0, NORMAL,    100, 10,   0, STATUS
	move CHARM,        EFFECT_ATTACK_DOWN_2,       0, FAIRY,     100, 20,   0, STATUS
	move ROLLOUT,      EFFECT_ROLLOUT,            30, ROCK,      100, 20,   0, PHYSICAL
	move FALSE_SWIPE,  EFFECT_FALSE_SWIPE,        80, NORMAL,    100, 40,   0, PHYSICAL
	move SWAGGER,      EFFECT_SWAGGER,             0, NORMAL,    100, 15, 100, STATUS
	...
	move STEEL_WING,   EFFECT_DEFENSE_UP_HIT,     80, STEEL,     100, 25,  10, PHYSICAL
	...
	move BUG_BUZZ,     EFFECT_SP_DEF_DOWN_HIT,    90, BUG,       100, 15,  10, SPECIAL
...
endc
	...
	move DYNAMICPUNCH, EFFECT_CONFUSE_HIT,       100, FIGHTING,  100, 10,  30, PHYSICAL
	move MEGAHORN,     EFFECT_NORMAL_HIT,        120, BUG,       100, 10,   0, PHYSICAL
...
endc
	...
	move IRON_TAIL,    EFFECT_DEFENSE_DOWN_HIT,  100, STEEL,     100, 10,  30, PHYSICAL
	move METAL_CLAW,   EFFECT_ATTACK_UP_HIT,      50, STEEL,     100, 35,  10, PHYSICAL
	...
	move HURRICANE,    EFFECT_CONFUSE_HIT,       110, FLYING,     90, 10,  30, SPECIAL
...
endc
	move CROSS_CHOP,   EFFECT_NORMAL_HIT,        100, FIGHTING,  100, 10,   0, PHYSICAL
	...
	move EXTREMESPEED, EFFECT_PRIORITY_HIT,       80, NORMAL,    100, 10,   0, PHYSICAL
	move ANCIENTPOWER, EFFECT_ALL_UP_HIT,         60, ROCK,      100, 10,  10, SPECIAL
...
endc
if DEF(FAITHFUL)
	move WHIRLPOOL,    EFFECT_TRAP,               35, WATER,     100, 15,   0, SPECIAL
else
	move WHIRLPOOL,    EFFECT_TRAP,               40, WATER,     100, 15,   0, SPECIAL
endc
	...
	move PLAY_ROUGH,   EFFECT_ATTACK_DOWN_HIT,    90, FAIRY,     100, 15,  10, PHYSICAL
	move DISARM_VOICE, EFFECT_ALWAYS_HIT,         40, FAIRY,     100, 15,   0, SPECIAL
	move STRUGGLE,     EFFECT_NORMAL_HIT,         40, UNKNOWN_T, 100,  1,   0, PHYSICAL
